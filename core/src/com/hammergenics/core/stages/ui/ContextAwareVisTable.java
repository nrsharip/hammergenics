 ...
 * @author nrsharip
 */
public abstract class ContextAwareVisTable extends VisTable {
    ...
    public ContextAwareVisTable(ModelEditScreen modelES, ModelEditStage stage) {
    ...
    public Array<EditableModelInstance> getNonPrimaryModelInstances() {
        return new Array<>(true, dbgModelInstances.toArray(), 1, dbgModelInstances.size - 1);
    }
