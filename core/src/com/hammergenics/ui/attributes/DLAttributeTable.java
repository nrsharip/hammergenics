 ...
 * @author nrsharip
 */
public class DLAttributeTable extends BaseLightsAttributeTable<DirectionalLightsAttribute, DirectionalLight> {

    public DLAttributeTable(Skin skin, Attributes container, ModelPreviewScreen mps) {
